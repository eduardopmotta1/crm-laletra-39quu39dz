...
export default function ProductionKanbanPage() {
  ...
  const stats = {
    ...
    dueToday: orders.filter((o) => {
      const dl = productionService.calculateDeadlineStatus(o.promised_deadline, o.is_completed)
      return dl.status === 'due_today'
    }).length,
    awaitingApproval: orders.filter((o) => o.stage_internal_id === 'awaiting_approval').length,
    inProduction: orders.filter((o) => o.stage_internal_id === 'in_production').length,
    ready: orders.filter((o) => o.stage_internal_id === 'ready').length,
    completed: orders.filter((o) => o.is_completed || o.stage_internal_id === 'completed').length,
  }
  ...
  return (
    <div className="flex flex-col h-full space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        ...
        <div
          onClick={() => setQuickFilter(quickFilter === 'in_production' ? 'all' : 'in_production')}
          className={`p-3 rounded-2xl border transition-all cursor-pointer ${
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">
              Kanban separado do comercial. Drag & drop livre entre etapas com alertas de prazo e
      ...
      <div className="flex-1 overflow-x-auto overflow-y-hidden pb-4">
        ...
        >
          {stages.map((stage) => {
            ...
            const totalStageValue = stageOrders.reduce((sum, o) => sum + (o.total_value || 0), 0)
            ...
            return (
              <div
                ...
                className={`w-68 shrink-0 flex flex-col max-h-[calc(100vh-270px)] rounded-2xl bg-slate-100/70 dark:bg-slate-900/60 border transition-all duration-200 ${
                  isTarget
              ...
              >
                ...
                <div className="p-3.5 border-b border-slate-200/80 dark:border-slate-800 flex flex-col gap-1">
                  ...
                  <span className="truncate text-[10px] text-slate-500" title={stage.description}>
