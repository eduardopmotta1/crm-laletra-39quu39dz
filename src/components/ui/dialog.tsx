...
const DialogOverlay = React.forwardRef<
  ...
  DialogOverlayProps
>(({ className, zIndexClass = 'z-50', ...props }, ref) => (
...
>(
  (
    ...
    <DialogPortal>
      <DialogOverlay zIndexClass={zIndexClass} className={overlayClassName} />
      <DialogPrimitive.Content
        ref={ref}
        onKeyDown={(e) => {
          // Garante que o evento de teclado dentro de um Dialog não borbulhe para diálogos pais na árvore DOM
          if (e.key === 'Escape') {
            e.stopPropagation()
          }
          onKeyDown?.(e)
